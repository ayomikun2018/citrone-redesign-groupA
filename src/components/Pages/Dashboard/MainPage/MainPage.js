      ...
      <div className='flex space-x-96'>
        <div className='relative dashboard-body-container pl-16 font-poppins' style={{}}>
            ...
            <div className='module1'>
              <div className='  z-0 bg-white drop-shadow-md rounded-l-xl p-7' style={{ width: "664px", height: "246px"}}>
              ...
              <div className=' z-0 -ml-36'>
                <img src={DashImage} alt='Display Module 12 img' className=' ' style={{ width: "325px", height: "246px", marginLeft: "486px", marginTop: "-288px"}}/>
              </div>
            </div>
